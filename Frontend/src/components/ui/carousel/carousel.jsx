...
const CarouselPrevious = React.forwardRef(({ className = "", variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={`carousel-prev ${orientation === "horizontal" ? "horizontal-prev" : "vertical-prev"} ${className}`}
...
const CarouselNext = React.forwardRef(({ className = "", variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size}
      className={`carousel-next ${orientation === "horizontal" ? "horizontal-next" : "vertical-next"} ${className}`}
